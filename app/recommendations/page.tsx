    ...
    <Layout>
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50">
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-3 md:py-4">
          ...
          {/* 안내 문구 - 탭별로 표시 */}
          {activeTab === 'recommended' && (
            <div className="bg-white border-2 border-gray-300 p-4 mb-3 md:mb-4">
              <div className="flex items-start gap-3 mb-3 border-b-2 border-gray-300 pb-3">
                <div className="w-1 h-6 bg-green-600"></div>
                <div className="flex-1">
                  <h4 className="text-xs font-bold text-gray-900 uppercase tracking-wide mb-1.5">추천 상품 안내</h4>
          ...
          {activeTab === 'excluded' && (
            <div className="bg-white border-2 border-gray-300 p-4 mb-3 md:mb-4">
              <div className="flex items-start gap-3 mb-3 border-b-2 border-gray-300 pb-3">
                ...
                <div className="flex-1">
                  <h4 className="text-xs font-bold text-gray-900 uppercase tracking-wide mb-1.5">부진재고 안내</h4>
          ...
          {Object.keys(filteredGroupedProducts).length === 0 ? (
            ...
            <div className="space-y-4 md:space-y-6">
              {Object.entries(filteredGroupedProducts).map(([category, products]) => (
                <div key={category}>
                  <div className="bg-white border border-gray-300 mb-3">
                    <div className="bg-gray-50 border-b border-gray-300 px-4 py-2.5">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="px-2.5 py-1 bg-white border border-gray-300">
                          <span className="text-xs text-gray-700 font-semibold">{products.length}개 상품</span>
                        </div>
                      </div>
                    </div>
                    ...
                    {products.map((product) => {
                      ...
                      return (
                        <div
                          ...
                          className={`group bg-white rounded-lg overflow-hidden border-2 transition-all duration-300 cursor-pointer flex flex-col relative ${
                            activeTab === 'recommended'
                              ? 'border-gray-100 hover:border-green-400 hover:shadow-lg hover:shadow-green-500/10 hover:-translate-y-0.5'
                              : 'border-gray-100 hover:border-orange-400 hover:shadow-lg hover:shadow-orange-500/10 hover:-translate-y-0.5'
                          ...
                          {isVisible ? (
                            <>
                              ...
                              <div className="p-2 md:p-3 flex flex-col h-full bg-white">
                                <h4 className="text-xs font-semibold text-gray-900 mb-1.5 line-clamp-2 min-h-[2rem] leading-tight group-hover:text-gray-700 transition-colors">
                                  {product.item_nm}
                                </h4>
                                ...
                                <div className="mb-2 space-y-1">
                                  {product.sale_price !== null && (
                                    <div className="flex items-baseline gap-1">
                                      <span className="text-[10px] text-gray-500 font-medium">판매가</span>
                                ...
                                <div className="flex items-center justify-between mt-auto pt-2 border-t border-gray-100">
                                  {product.item_smdv_nm ? (
                                    <span className="text-[10px] text-gray-600 bg-gray-50 px-1.5 py-0.5 rounded border border-gray-200 font-medium">
                                      {product.item_smdv_nm}
                                    </span>
                                  ) : (
                                    <span></span>
